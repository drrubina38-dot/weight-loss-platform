...
export const reviews: Review[] = [
  {
    ...
    city: "Lahore",
    rating: 5,
    result: "Lost 7 kg in 1 months",
    text: "I was struggling with my weight after my second baby. Dr Rubina Powder helped control my cravings and I finally started losing weight without feeling weak. Delivery was fast and COD made it so easy.",
  },
  {
    name: "Bilal Ahmed",
    city: "Karachi",
    rating: 5,
    result: "Lost 15 kg in 6 weeks",
